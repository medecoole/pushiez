...
public class PiglinPlushieBlock extends HorizontalFacingBlock implements Equipment, Waterloggable {
    public static final BooleanProperty WATERLOGGED = Properties.WATERLOGGED;

    public PiglinPlushieBlock(Settings settings) {
